We have made sure that installing AtlasOS is not a hard process. The installation process takes only a few minutes longer than when you normally install Windows. Let us start setting up Atlas.
...
!!! info ""
    After the complete and successful installation of Atlas, continue the [Post-Installation - Activate Windows](https://docs.atlasos.net/Getting%20started/Post-Installation/Activate%20Windows) section in our documenatation, and then continue to other sections.
