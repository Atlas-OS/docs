...
If you're using Atlas and have not enabled [Automatic Driver Installation](../../post-install/drivers/index.md#want-driver-installation-updates-through-windows-update-instead), you will need to install the Apple USB driver manually.
